...
firstroute.get('/', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                query = req.query;
                fileName = query.fileName, widths = query.widths, heights = query.heights;
                ...
                if (!fs_1.default.existsSync(absolutePath)) return [3 /*break*/, 6];
                if (!(width || height)) return [3 /*break*/, 4];
                if (!(width > 0 && height > 0)) return [3 /*break*/, 2];
                place = (0, resize_1.resize)(width, height, fileName);
                _b = (_a = res).sendFile;
                return [4 /*yield*/, Promise.resolve(place)];
            case 1:
